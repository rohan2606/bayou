...
def train(clargs):
    ...
    dataset = tf.data.Dataset.from_tensor_slices(( nodes_placeholder, edges_placeholder,  *evidence_placeholder, \
                                        *neg_evidence_placeholder))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save', type=str, default='save_no_max',

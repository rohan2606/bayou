...
class BayesianPredictor(object):
    ...
    def get_all_latent_vectors(self):
        ...
        [prog_psi_enc, prog_psi_rev_enc_neg, prog_psi_rev_enc] = self.sess.run([self.model.psi_encoder, self.model.psi_reverse_encoder_negative, self.model.psi_reverse_encoder])

        return prog_psi_enc, prog_psi_rev_enc_neg, prog_psi_rev_enc
